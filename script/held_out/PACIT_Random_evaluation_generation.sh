...
CUDA_VISIBLE_DEVICES=$gpu_vis python \
    ...
    --run_name "PACIT_train_few-shot_Random_pos_${NUM_EXP}_neg_${NUM_EXP}/${HELD_IN_OR_OUT}/inference_zero-shot" \
    --model_name_or_path "./output/$PROJECT_NAME/PACIT_train_few-shot_Random_pos_${NUM_EXP}_neg_${NUM_EXP}/${CHECKPOINT}/pytorch_model.bin" \
...
CUDA_VISIBLE_DEVICES=$gpu_vis python \
    ...
    --output_dir "./output" \
    --project_name $PROJECT_NAME \
    --run_name "PACIT_train_few-shot_Random_pos_${NUM_EXP}_neg_${NUM_EXP}/${HELD_IN_OR_OUT}/inference_zero-shot_Random" \
    --model_name_or_path "./output/$PROJECT_NAME/PACIT_train_few-shot_Random_pos_${NUM_EXP}_neg_${NUM_EXP}/${CHECKPOINT}/pytorch_model.bin" \
...
CUDA_VISIBLE_DEVICES=$gpu_vis python \
    ...
    --output_dir "./output" \
    --project_name $PROJECT_NAME \
    --run_name "PACIT_train_few-shot_Random_pos_${NUM_EXP}_neg_${NUM_EXP}/${HELD_IN_OR_OUT}/inference_few-shot" \
    --model_name_or_path "./output/$PROJECT_NAME/PACIT_train_few-shot_Random_pos_${NUM_EXP}_neg_${NUM_EXP}/${CHECKPOINT}/pytorch_model.bin" \
    --data_path "./data/seed-42/defintion_pos_${NUM_EXP}_neg_${NUM_EXP}_train_60_test_100/${HELD_IN_OR_OUT}/test/PACIT-few-shot-Random.jsonl" \
    --eval_batch_size 1 \
    --max_new_tokens 128 \
    --temperature 0 \
    --max_length 1024 \
...
CUDA_VISIBLE_DEVICES=$gpu_vis python \
    ...
    --output_dir "./output" \
    --project_name $PROJECT_NAME \
    --run_name "PACIT_train_few-shot_Random_pos_${NUM_EXP}_neg_${NUM_EXP}/${HELD_IN_OR_OUT}/inference_few-shot_GT" \
    --model_name_or_path "./output/$PROJECT_NAME/PACIT_train_few-shot_Random_pos_${NUM_EXP}_neg_${NUM_EXP}/${CHECKPOINT}/pytorch_model.bin" \
...
CUDA_VISIBLE_DEVICES=$gpu_vis python \
    ...
    --output_dir "./output" \
    --project_name $PROJECT_NAME \
    --run_name "PACIT_train_few-shot_Random_pos_${NUM_EXP}_neg_${NUM_EXP}/${HELD_IN_OR_OUT}/inference_few-shot_Random" \
    --model_name_or_path "./output/$PROJECT_NAME/PACIT_train_few-shot_Random_pos_${NUM_EXP}_neg_${NUM_EXP}/${CHECKPOINT}/pytorch_model.bin" \
